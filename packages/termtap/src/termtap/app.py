...
from .tmux import (
    list_sessions, capture_visible, capture_all, capture_last_n
)
...
@app.command(
    display="table", 
    headers=["Session", "Process", "State", "Attached"], 
...
@app.command(
    fastmcp={"type": "tool", "description": "Send interrupt (Ctrl+C) to a session"}
)
