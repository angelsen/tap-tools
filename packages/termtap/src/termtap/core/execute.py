"""Command execution orchestration - hook-native design.
...
@dataclass
class ExecutorState:
    """Manages streaming state across executions."""
...
def execute(
    ...
    Args:
        ...
        target: Target specification (session name or "default")
    ...
    if send_handler:
        ...
        command = modified_command  # Only update if not None
    ...
    # Timeout - get final process state
