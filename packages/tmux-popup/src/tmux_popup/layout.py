...
class Column(Element):
    ...
    def __init__(self, *elements, width=None, height=None, 
                 border: BorderStyle = "hidden", align: Align = "left", padding=None, margin=None):
    ...
    def render_with_allocation(self, builder, allocated_width=None, allocated_height=None) -> str:
        ...
        if len(content_vars) > 1:
            content = builder.add_join(content_vars, vertical=True, 
                                      result_name=f"COL{col_index}_CONTENT")
        else:
...
class Row(Element):
    ...
    def render_with_allocation(self, builder, allocated_width=None, allocated_height=None) -> str:
        ...
        # Join horizontally
        return builder.add_join(element_vars, vertical=False, 
                               result_name=f"ROW{row_index}_JOINED")